...
define [
    ...
    angular.module("template/datepicker/popup.html", []).run [
      ...
      ($templateCache) ->
        ...
        "<ul class=\"dropdown-menu dropdown-datepicker\" ng-style=\"{display: (isOpen && 'block') || 'none', top: position.top+'px', left: position.left+'px'}\" ng-keydown=\"keydown($event)\">\n" +
        "\t<li ng-transclude class=\"date-picker-pager\"></li>\n" +
        "\t<li ng-if=\"showButtonBar\" class=\"date-picker-controls\">\n" +
